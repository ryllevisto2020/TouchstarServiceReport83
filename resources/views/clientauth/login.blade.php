    ...
    <div class="hidden md:flex w-2/5 items-center justify-center gradient-bg p-8 relative">
      ...
      <div class="text-center z-10">
        ...
        <p class="text-white/70 text-sm max-w-xs mx-auto pb-12">
            Securely access your client portal and manage your services with Touchstar.        
        </p>
      </div>
    ...
    <div class="flex w-full md:w-3/5 items-center justify-center bg-white p-8 md:p-10 form-section">
      <div class="w-full max-w-sm z-10">
        ...
        <div class="text-center mb-8">
          <h2 class="text-2xl font-bold text-gray-800 mb-2">Client Portal Login</h2>
          <p class="text-gray-600 text-sm">Sign in to securely access your account and services</p>
        </div>
        ...
        <!-- Login Form -->
        <form method="POST" action="/client/login/auth" class="space-y-5">
          @csrf
